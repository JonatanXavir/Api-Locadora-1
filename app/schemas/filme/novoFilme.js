module.exports = {
  ...
  properties: {
    ...
    ano: { type: 'integer', minimum: 1888, maximum: new Date().getFullYear() + 1, errorMessage: 'O ano de lançamento é inválido.' },
    disponivel: { type: 'boolean', default: true, errorMessage: 'O campo "disponivel" deve ser um valor booleano (true/false).' },
  },
  required: ['titulo', 'diretor', 'ano'],
